...
@Component({
  selector: 'true-filter-text-mat',
  templateUrl: 'filter-text-mat.component.html',
  styles: [`
    :host {
      display: block;
      width: 27em;
...
export class FilterTextMatComponent extends FilterBaseComponent {
  ...
  public listColumns: Column[] = [
    new Column('checked', 'Checked', 50, ColumnType.CHECKBOX, ''), // В некоторых местах четко задано 28
