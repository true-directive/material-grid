...
import { DialogAlertComponent } from '@true-directive/grid';
import { DialogButton, DialogInfo } from '@true-directive/grid';
 ...
 */
@Component({
  selector: 'true-dialog-wrapper-mat',
  templateUrl: 'dialog-wrapper-mat.component.html',
  styleUrls: ['dialog-wrapper-mat.component.scss']
})
export class DialogWrapperMatComponent implements OnDestroy {
